...
//                             style={{
//                                 backgroundColor:
//                                     PRIORITY_DOT[task.priority] || "#CBD5E1",
//                             }}
//                         />
//                         <span className="text-[11px] font-medium text-gray-500">
//                             {task.priority}
...
//                         Dispatched by {task.creator.name}
//                     </p>
//                 )}
//             </div>
//         </div>
...
//                     route("ourtaskassigned.index", { page }),
//                 );
...
//         const roles = [
//             ...new Set(
//                 allTaskAssigned.map((t) => t.department).filter(Boolean),
//             ),
//         ];
...
//             if (q) {
//                 const haystack =
//                     `${t.task_id} ${t.title} ${t.description || ""}`.toLowerCase();
//                 if (!haystack.includes(q)) return false;
//             }
//             if (
//                 isPrivileged &&
//                 deptFilter !== "all" &&
//                 t.department !== deptFilter
//             )
//                 return false;
...
//                 mineOnly &&
//                 currentUser &&
//                 t.assigned_team !== currentUser.id
//             )
//                 return false;
//             return true;
//         });
...
//                 axios.post(route("ourtaskassigned.store"), formData, {
//                     headers: { "Content-Type": "multipart/form-data" },
//                 }),
//                 {
...
//             formData.append("_method", "PUT");
//             const response = await toast.promise(
//                 axios.post(route("ourtaskassigned.update", { id }), formData, {
//                     headers: { "Content-Type": "multipart/form-data" },
//                 }),
//                 {
...
//                 route("ourtaskassigned.review", { id }),
//                 {
//                     admin_status,
//                     admin_remarks,
//                 },
...
//             await toast.promise(
//                 axios.delete(
//                     route("ourtaskassigned.attachments.destroy", {
//                         task: taskId,
...
//         try {
//             await toast.promise(
//                 axios.delete(route("ourtaskassigned.destroy", { id })),
//                 {
...
//         if (
//             newPage < 1 ||
//             newPage > meta.last_page ||
//             newPage === meta.current_page
//         )
//             return;
//         setPage(newPage);
//     };

//     const openTickets = allTaskAssigned.filter(
...
const TaskCard = ({ task, onEdit, onView, onDelete, isAdmin }) => {
    const progress = getProgress(task.task_items);
    const isLocked = task.status === "Completed";
    // Don't show a countdown/overdue badge once the task is done — it's
    // meaningless after completion and reads as "3d overdue" on a task
