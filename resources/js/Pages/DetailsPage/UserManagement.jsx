...
//                 setAllUser(response.data.users || response.data || []);
//             } catch (error) {
...
//                         {/* <div className="h-8 w-8 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center text-sm font-semibold flex-shrink-0">
...
const UserManagement = () => {
    ...
    // Called by AddUserForm on successful store
    ...
    // Called by AddUserForm on store error
    const handleAddError = () => {
        toast.error("Failed to create user. Please try again.");
    };

    // Called by EditUserForm on successful update
    ...
    // Called by EditUserForm on update error
