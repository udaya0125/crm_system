...
//                 {/* Header */}
//                 <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 px-6 pt-6 pb-10 relative">
//                     <button
//                         onClick={onClose}
...
//                         </div>
//                         <div>
//                             <p className="text-indigo-200 text-xs font-mono tracking-widest mb-0.5">
//                                 {lead.lead_id}
//                             </p>
...
//                 <div className="flex-1 overflow-y-auto -mt-4 bg-white rounded-t-2xl px-6 pt-5 pb-6">
...
//                             value={lead.assigned_salesperson}
//                         />
//                         <Field
//                             icon={CalendarClock}
...
//                         <Field icon={StickyNote} label="Notes" value={lead.notes} />
//                     </div>
//                 </div>
