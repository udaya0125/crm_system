...
const ProjectManagement = () => {
    ...
    const handleDelete = (id) => {
        ...
        toast.promise(axios.delete(route("ourprojects.destroy", { id })), {
    ...
    const handleTaskUpdate = async (projectId, updatedTasks) => {
        try {
            ...
            await toast.promise(
                axios.post(route("ourprojects.update", { id: projectId }), formData, {
                    headers: { "Content-Type": "multipart/form-data" },
                }),
                {
    ...
    return (
        <>
            <AdminWrapper>
                ...
                {!loading && filteredProjects.length === 0 && allProjects.length > 0 && (
                    <div className="flex flex-col items-center justify-center py-12 text-stone-400 bg-stone-50 rounded-lg mb-4">
