...
//                 <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-14 items-start">
...
//                             <div className="absolute inset-0 bg-gradient-to-t from-gray-950/90 via-gray-900/60 to-gray-800/30" />

//                             {/* Content on top of image */}
//                             <div className="relative z-10 h-full flex flex-col justify-between p-9" style={{ minHeight: "680px" }}>

//                                 {/* Top badge */}
//                                 <div className="flex items-center gap-2 self-start">
//                                     <span className="flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 text-white text-xs font-medium px-3.5 py-1.5 rounded-full">
...
//                                 <div>
//                                     {/* Decorative line */}
//                                     <div className="w-10 h-0.5 bg-indigo-400 mb-5 rounded-full" />
...
//                                             <span
//                                                 key={tag}
//                                                 className="text-xs font-medium text-white/80 bg-white/10 border border-white/15 backdrop-blur-sm px-3 py-1.5 rounded-full"
//                                             >
//                                                 {tag}
//                                             </span>
//                                         ))}
...
//                                             <p className="text-xs text-white/55 mt-0.5">Avg. response</p>
//                                         </div>
//                                         <div>
//                                             <p className="text-xl font-bold text-white">98%</p>
//                                             <p className="text-xs text-white/55 mt-0.5">Satisfaction rate</p>
//                                         </div>
//                                         <div>
//                                             <p className="text-xl font-bold text-white">24/7</p>
//                                             <p className="text-xs text-white/55 mt-0.5">Availability</p>
//                                         </div>
//                                     </div> */}
//                                 </div>
//                             </div>
...
//                 <div className="bg-[#f9fafc] rounded-3xl shadow-xl border border-gray-100 overflow-hidden transition-all duration-200">
//                     {/* Section: Contact info */}
