...
//   // Set form value when selectedCompany changes
//   useEffect(() => {
//     if (selectedCompany) {
...
//   if (!isModalOpen || !selectedCompany) return null;
...
//             <h2 className="font-medium text-gray-600">Company Name:</h2>
...
//                     className="mt-2 w-full px-3 py-2 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50"
//                   >
//                     {followUpLoading ? "Updating..." : "Update Follow-up Date"}
//                   </button>
//                 </form>
//               </div>
//             </div>
...
//                   onClick={() =>
//                     toast.success("Navigating to full details...")
//                   }
//                 >
                ...
                {/* <div className="sticky bottom-0 bg-white px-6 py-4 border-t border-gray-200">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex gap-3">
                            <button
                                onClick={closeModal}
                                className="px-4 py-2.5 text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors text-sm font-medium border border-gray-300"
                            >
                                Close
                            </button>
                            <Link
                                href={`/crm/details/${selectedCompany.slug}`}
                                className="px-4 py-2.5 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors text-sm font-medium"
                            >
                                Edit Details
                            </Link>
                        </div>
