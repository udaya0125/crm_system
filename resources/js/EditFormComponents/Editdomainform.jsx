...
const EditDomainForm = ({ editingDomain, handleUpdate, onClose }) => {
    ...
    // Pre-populate form when clients are ready
    useEffect(() => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="relative px-6 py-6 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white shadow-2xl">
                ...
                <div className="flex justify-between items-center mb-6 pb-4 border-b">
                    <h2 className="text-2xl font-bold text-stone-800">Edit Domain</h2>
                    <button
                        type="button"
                        onClick={onClose}
