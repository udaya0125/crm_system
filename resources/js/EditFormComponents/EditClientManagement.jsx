...
const EditClientManagement = ({
    ...
    // Pre-select lead + company once leads are loaded
    useEffect(() => {
            ...
            if (match) {
                ...
                setSelectedCompany(
                    editingClient.company_name
                        ? { value: editingClient.company_name, label: editingClient.company_name }
                        : null
                );
            }
        }
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="relative px-6 py-6 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white shadow-2xl">
                ...
                <div className="flex justify-between items-center mb-6 pb-4 border-b sticky top-0 bg-white z-10">
                    <h2 className="text-2xl font-bold text-stone-800">Edit Client</h2>
...
export default EditClientManagement;