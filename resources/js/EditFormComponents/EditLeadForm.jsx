...
const EditLeadForm = ({ editingLead, handleUpdate, onClose }) => {
    const [submitting, setSubmitting] = useState(false);
    const [leadForm, setLeadForm] = useState(emptyForm);

    // Populate form with the lead being edited
    useEffect(() => {
        if (editingLead) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="relative px-6 py-6 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white shadow-2xl">
                ...
                <div className="flex justify-between items-center mb-6 pb-4 border-b">
                    <h2 className="text-2xl font-bold text-stone-800">Edit Lead</h2>
                    <button
                        type="button"
                        onClick={onClose}
