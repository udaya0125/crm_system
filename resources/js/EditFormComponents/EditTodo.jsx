...
const EditTodo = ({ editingTodo, onClose, handleUpdate }) => {
    const {
        register,
        handleSubmit,
        control,
    ...
    // Properly populate form when editingTodo changes
    useEffect(() => {
        if (editingTodo) {
            const descriptionFields = [];

            if (
                editingTodo.descriptions &&
            ...
            >
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-0.5">
                                Update the details, notes, or status of this
                                task
                            </p>
                        </div>
                    </div>
                ...
                >
                    <div className="overflow-y-auto px-6 py-6 space-y-6">
                        ...
                        {/* Status — segmented control instead of a plain select */}
                        <div>
                            <label className="block text-xs font-semibold uppercase tracking-wide text-gray-500 mb-1.5">
                                Status
                            </label>
