    ...
    useEffect(() => {
        if (expirationForm.last_renewal_date && expirationForm.duration) {
            ...
            if (!isNaN(durationMonths) && durationMonths > 0) {
                ...
                expirationDate.setMonth(lastRenewal.getMonth() + durationMonths);
    ...
    const validateForm = () => {
        ...
        if (!expirationForm.last_renewal_date) {
            ...
            if (selectedDate > today) {
                newErrors.last_renewal_date = "Last renewal date cannot be in the future";
            }
        }
        ...
        if (!expirationForm.duration) {
            ...
            if (durationValue <= 0) {
                ...
                newErrors.duration = "Duration cannot exceed 120 months (10 years)";
            }
        }
        ...
        <div className="p-6 text-gray-800">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                            Last Renewal Date <span className="text-red-500">*</span>
                        </label>
                        <input
                            type="date"
                            ...
                            className={`w-full px-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 ${
                                errors.last_renewal_date ? 'border-red-500' : 'border-gray-300'
                            }`}
                            disabled={submitting}
                            required
                        />
                        {errors.last_renewal_date && (
                            <p className="mt-1 text-sm text-red-600">{errors.last_renewal_date}</p>
                        )}
                    </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-xs text-gray-500 flex items-center gap-1">
                            Automatically calculated based on last renewal date + duration (months)
                        </p>
                    </div>
                </div>
...
export default AddExpirationForm;
...
//                 last_renewal_date: editingExpiration.last_renewal_date?.split('T')[0] || '',
//                 duration: editingExpiration.duration || '',
//                 expiration_date: editingExpiration.expiration_date?.split('T')[0] || '',
//             });
            
//             // Set selected client for react-select
//             if (editingExpiration.client_id && clients.length > 0) {
//                 const client = clients.find(c => c.id === editingExpiration.client_id);
//                 if (client) {
//                     setSelectedClient({
//                         value: client.id,
//                         label: client.organization_name || client.name
...
//                 <div className="flex items-center space-x-3">
//                     <h2 className="text-2xl font-bold text-gray-900">
//                         {editingExpiration ? 'Edit Expiration' : 'Add New Expiration'}
//                     </h2>
//                 </div>
//                 <button
//                     onClick={handleCancel}
...
//                             type="text"
//                             name="title"
//                             value={expirationForm.title}
//                             onChange={handleChange}
//                             className={`w-full px-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 ${
//                                 errors.title ? 'border-red-500' : 'border-gray-300'
//                             }`}
//                             placeholder="e.g., SSL Certificate, Domain Registration"
//                             disabled={submitting}
//                             required
//                         />
//                         {errors.title && (
...
//                                     />
//                                 </svg>
//                                 {editingExpiration ? 'Updating...' : 'Creating...'}
//                             </span>
//                         ) : (
//                             <span>{editingExpiration ? 'Update Expiration' : 'Create Expiration'}</span>
//                         )}
//                     </button>
//                 </div>
//             </form>
...
//                 const titleOption = titleOptions.find(t => t.value === editingExpiration.title);
//                 if (titleOption) {
