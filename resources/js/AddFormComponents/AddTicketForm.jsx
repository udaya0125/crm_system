...
//             // Set selected technician for react-select
//             if (editingTicket.assigned_technician) {
//                 const technicianOption = users.find(
//                     user => user.value === editingTicket.assigned_technician
//                 );
...
//     // Handle technician change with react-select
//     const handleTechnicianChange = (selectedOption) => {
//         setSelectedTechnician(selectedOption);
//         setTicketForm((prev) => ({ 
//             ...prev, 
