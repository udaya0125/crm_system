...
//     useEffect(() => {
//         if (editingLead) {
//             setLeadForm({ ...emptyForm, ...editingLead });
//         } else {
//             setLeadForm(emptyForm);
//         }
//     }, [editingLead]);
...
//         for (const key in leadForm) {
//             if (leadForm[key] !== null && leadForm[key] !== "") {
//                 // For rich text notes, we want to keep the HTML content
//                 formData.append(key, leadForm[key]);
//             }
//         }
...
//                             <Select
//                                 name="status"
//                                 value={statusOptions.find(option => option.value === leadForm.status) || null}
//                                 onChange={handleStatusChange}
//                                 options={statusOptions}
//                                 placeholder="— Select Status —"
//                                 isClearable
...
//                 /* Optional: Style the toolbar to match your design */
