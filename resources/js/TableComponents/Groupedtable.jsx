 ...
 *
 * Props:
 *  - rows          : array of flat records from the API
 *  - groupKey      : keyof each row that holds the parent object  e.g. "category" | "sub_category"
 *  - columns       : column definitions (react-table ColumnDef[])
 *  - loading       : boolean
 *  - emptyMessage  : string shown when rows === []
 *  - footerLeft    : ReactNode | string  (e.g. "3 categories")
 *  - footerRight   : ReactNode | string  (e.g. "12 total subcategories")
 */
const GroupedTable = ({
    rows = [],
                                                ...
                                                ? tableRow.getVisibleCells().map((cell) => (
                                                      ...
                                                      >
                                                          {flexRender(
                                                              ...
                                                              { ...cell.getContext(), groupIndex: index },
                                                          )}
                                                      </td>
                                                  ))
                                                : null}
